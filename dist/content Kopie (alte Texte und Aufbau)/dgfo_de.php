      ...
      <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
          ...
          <p>
            ...
            Systematik und Neubeschreibungen von Gliedertieren. Die Zeitschrift wurde
            ...
            <a href="http://www.dgaae.de" target="_blank">
              Fabricius-Medaille der Deutschen Gesellschaft für Entomologie
            </a> (1959), seine Ernennung zum
            <a href="http://www.nhm-wien.ac.at/" target="_blank">
              Korrespondenten des Naturhistorischen Museums Wien
            </a> 1976, die Verleihung des Bundesverdienstkreuzes am Bande im Jahr 1983
          ...
          <ul class="dgfo">
              ...
              <div class="row">
                <div class="col-lg-11 col-md-11 col-sm-10 col-xs-10">
                  ...
                  Articulata 11 (2): 1–2.</li>
                </div>
                <div class="col-lg-1 col-md-1 col-sm-2 col-xs-2">
                  <?php
                    if (file_exists("downloads/articulata/articulata_XI_1996/kleinert_1996.pdf")) {
                  ?>
                    <a href="downloads/articulata/articulata_XI_1996/kleinert_1996.pdf" target="_blank">
                      <button type="button" class="btn btn-default">
                        <img src="images/pdf.jpg" alt="pdf" class="img-rounded " style="margin: 0 auto;">
                      </button>
                    </a>
                  <?php
                } else {
                  echo "<p><label class='label label-danger'>fehlt</label></p>";
                }
                  ?>
                </div>
              </div>
              <div class="row">
                ...
                <div class="col-lg-1 col-md-1 col-sm-2 col-xs-2">
                  ...
                  ?>
                    <a href="downloads/articulata/articulata_XI_1996/detzel_1996.pdf" target="_blank">
                      <button type="button" class="btn btn-default">
                        <img src="images/pdf.jpg" alt="pdf" class="img-rounded " style="margin: 0 auto;">
                      </button>
                    </a>
              ...
              <div class="row">
                ...
                <div class="col-lg-1 col-md-1 col-sm-2 col-xs-2">
                  <?php
                    if (file_exists("downloads/articulata/articulata_XIII_1998/heller_1998.pdf")) {
                  ?>
                      <a href="downloads/articulata/articulata_XIII_1998/heller_1998.pdf" target="_blank">
                        <button type="button" class="btn btn-default">
                          <img src="images/pdf.jpg" alt="pdf" class="img-rounded " style="margin: 0 auto;">
                        </button>
                      </a>
              ...
              <div class="row">
                ...
                <div class="col-lg-1 col-md-1 col-sm-2 col-xs-2">
                  <?php
                    if (file_exists("downloads/articulata/articulata_XIV_1999/heller_1999.pdf")) {
                  ?>
                    <a href="downloads/articulata/articulata_XIV_1999/heller_1999.pdf" target="_blank">
                      <button type="button" class="btn btn-default">
                        <img src="images/pdf.jpg" alt="pdf" class="img-rounded " style="margin: 0 auto;">
                      </button>
                    </a>
          ...
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              ...
              <div class="row">
                <div class="col-lg-2 col-md-3 col-sm-4 col-xs-4">
                  <figure>
                      <img src="images/people/tumbrinck.jpg" alt="Josef Tumbrinck" class="img-rounded img-responsive">
                  </figure>
                </div>
                <div class="col-lg-10 col-md 9 col-sm-8 col-xs-8">
                  <p>
          ...
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              ...
              <div class="row">
                <div class="col-lg-2 col-md-3 col-sm-4 col-xs-4">
                  <figure>
                      <img src="images/people/schirmel.jpg" alt="Jens Schirmel" class="img-rounded img-responsive">
                  </figure>
                </div>
                <div class="col-lg-10 col-md 9 col-sm-8 col-xs-8">
                  <p>
          ...
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              ...
              <div class="row">
                <div class="col-lg-2 col-md-3 col-sm-4 col-xs-4">
                  <figure>
                      <img src="images/people/waeber.jpg" alt="Georg Waeber" class="img-rounded img-responsive">
                  </figure>
                </div>
                <div class="col-lg-10 col-md 9 col-sm-8 col-xs-8">
                  <p>
