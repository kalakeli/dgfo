 ...
 <div class="row">
    <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
      ...
      <p>
        ...
        Ein wesentlicher Schwerpunkt soll dabei auf naturschutzrelevanten Gebieten
        liegen. Dies beinhaltet:
      </p>
      <ul class="dgfo">
        <p><li>Die Erfassung, Auswertung und Veröffentlichung wissenschaftlicher Daten
          aller Forschungsrichtungen über Orthopteren (z.B. Taxonomie, Morphologie,
          Ökologie, Faunistik, Physiologie).</li></p>
        <p><li>Die Fortführung der seit 1975 von Dr. h.c. Kurt Harz herausgegebenen
          Zeitschrift &bdquo;Articulata&ldquo;, der Zeitschrift für Orthopteren
      ...
      <ol class="dgfo">
        <p><li>Der Verein verfolgt ausschließlich und unmittelbar gemeinnützige und
          ...
          Zwecke&ldquo; der Abgabenordnung.</li></p>
      ...
      <ol class="dgfo">
        ...
        <li>Die Mitgliedschaft endet:
          <ul class="dgfo">
            <p><li>durch Austritt (dieser kann nur am Ende eines Kalenderjahres unter Einhaltung einer Frist von 3 Monate schriftlich erfolgen)</li></p>
            <p><li>nach Ausschluß aus gewichtigem Grund durch einen 2/3 Mehrheitsbeschluß im Vorstand</li></p>
            <p><li>durch Tod</li></p>
          </ul>
        </li>
      </ol>
<br><hr>
      ...
      <ul class="dgfo">
        <p><li>die Mitgliederversammlung</li></p>
...
<br><hr>
      ...
      <ol class="dgfo">
        <p><li>Stimmberechtigt ist jedes Mitglied. Familien-, Firmen-,
          ...
          Person vertreten.</li></p>
        <p><li>Aufgaben der Mitgliederversammlung:
          <ul class="dgfo">
            <p><li>Wahl des Vorstandes und Bestätigung des Beirates.</li></p>
            <p><li>Entgegennahme des Geschäftsberichtes und die Entlastung des Vorstandes.</li></p>
            <p><li>Ernennung der Kassenprüfer.</li></p>
            <p><li>Beschlußfassung über die Höhe des Mitgliedsbeitrages.</li></p>
            <p><li>Beratung und Beschlußfassung über die Satzungsänderungen und die
              Auflösung des Vereins (Beschlüsse dieser Art benötigen 2/3 Mehrheiten
              der anwesenden Mitglieder. Auf Satzungsänderungen ist in der
              Tagesordnung gesondert hinzuweisen).</li></p>
            <p><li>alle übrigen Aufgaben, soweit sie nicht im Einzelnen dem Vorstand übertragen sind.</li></p>
          </ul>
        </li></p>
        <p><li>Die Mitgliederversammlung findet mindestens einmal im Jahr statt. Eine Einladung muß schriftlich mit Angabe der Tagesordnung 2 Wochen vor der Versammlung erfolgen.</li></p>
        <p><li>Anträge auf:
          <ul class="dgfo">
            <p><li>Auflösung</li></p>
            <p><li>Satzungsänderungen</li></p>
            <p><li>konstruktives Mißtrauen</li></p>
          </ul>
      ...
      <ol class="dgfo">
        <p><li>Der Vorstand besteht aus 3 gleichberechtigten Mitgliedern und setzt sich zusammen aus:
          <ul class="dgfo">
            <p><li>dem Vorsitzenden</li></p>
            <p><li>dem ersten stellvertretenden Vorsitzenden</li></p>
            <p><li>dem Schriftführer</li></p>
          </ul>
        </li></p>
        <p><li>Der Vorstand wird auf die Dauer von 2 Jahren gewählt.</li></p>
        </p><li>Aufgaben des Vorstandes:
          <ul class="dgfo">
            <p><li>Leitung des Vereins und Führung seiner Geschäfte nach Gesetz und Zweck des Vereins.</li></p>
            <p><li>Einberufung der Mitgliederversammlung und deren Leitung.</li></p>
          </ul>
        </li></p>
        <p><li>Der Vorstand ist beschlußfähig, wenn mehr als die Hälfte seiner Mitglieder anwesend sind.</li></p>
      ...
      <p>
        ...
        Naturschutz und Organisationen, die satzungsgemäße und dieselbe
        steuerbegünstigten Zwecke verfolgen, die in Artikel 2 formuliert sind.
        Die Mittel dürfen nur zu unmittelbaren und ausschließlichen Verwendung
        für gemeinnützige Zwecke eingesetzt werden.
      </p></div>
<!-- rechte Spalte -->
    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
      <h2></h2>
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          <h3 class="panel-title">KONTAKT | MITGLIEDSCHAFT</h3>
        </div>
        <div class="panel-body">
          <div class="row">
            <div class="col-sm-12 col-xs-12">
              <h4>Deutsche Gesellschaft für Orthopterologie</h4><h4>Dr. Jens Schirmel</h4>
              <p>
